/**
 * apps/portal/src/app/engagements/[engagementId]/messages/page.tsx
 *
 * CLIENT per-engagement thread view — read + reply + attach + retrieve.
 *
 * Renders the engagement's message thread for the CLIENT: ordered message list with
 ...
 * AC-MSG-001-04: CLIENT can read + contribute (ThreadView + MessageComposer).
 ...
 * ADR-006: /engagements/{id}/messages is apps/portal — CLIENT read + compose. // ADR-006
...
export const metadata: Metadata = {
  title: "Messages",
  description: "Engagement message thread.",
};

// ─── Page ─────────────────────────────────────────────────────────────────────

export default async function PortalEngagementMessagesPage({ params }: MessagesPageProps) {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div
          ...
          data-testid="portal-engagement-messages-unauthorized"
        >
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Breadcrumb navigation — consistent with documents/participants sub-pages */}
      <div className="mb-2">
        <a
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Send and receive messages with your accountant about this engagement.
        </p>
      </div>
      ...
      {loadError && (
        <div
          ...
          data-testid="portal-engagement-messages-load-error"
        >
      ...
      <div
        ...
        data-testid="portal-engagement-messages-panel"
      >
        ...
        {/* AC-MSG-001-04: CLIENT reads here; composes via MessageComposer below */}
        {!loadError && (
          <ThreadView
            messages={messages}
        ...
        {/* Message composer — AC-MSG-001-04: CLIENT can contribute */}
        {!loadError && thread && (
          <MessageComposer engagementId={engagementId} />
        )}
      </div>

      {/* Sub-page navigation — consistent with documents/participants */}
