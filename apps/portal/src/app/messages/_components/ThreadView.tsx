/**
 * apps/portal/src/app/messages/_components/ThreadView.tsx
 *
 * Thread view for the CLIENT (portal) per-engagement messages page.
 *
 ...
 *
 * CS-TS-003: mirrors ThreadView in apps/admin (same render, per-surface imports). // CS-TS-003
...
export interface ThreadViewProps {
  ...
  /** The viewing CLIENT's clerkUserId — used to distinguish sent vs. received. */
...
/**
 * ThreadView — renders the ordered message history for a thread (CLIENT surface).
 *
 ...
 * AC-MSG-001-04: CLIENT reads + can compose (MessageComposer is the sibling component).
 *
 * // AC-MSG-001-04 // AC-MSG-002-03 // AC-MSG-003-01 // AC-MSG-003-02 // AC-MSG-003-03
 * // AC-MSG-004-02 // CS-TS-003 // ADR-006 // CS-GEN-001 // CS-GEN-003
 */
