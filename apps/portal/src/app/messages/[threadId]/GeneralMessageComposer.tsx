/**
 * apps/portal/src/app/messages/[threadId]/GeneralMessageComposer.tsx
 *
 * Compose + send (+ optional attach) control for the CLIENT's general-thread view.
 *
 * Functionally identical to MessageComposer in the engagement-thread view but:
 ...
 *
 * AC-MSG-001-04: CLIENT can send messages in the general thread.
 ...
 * CS-TS-003: mirrors GeneralMessageComposer in apps/admin/src/app/messages/[threadId]. // CS-TS-003
...
export interface GeneralMessageComposerProps {
  ...
  threadId: string;
  /** Callback after a message is successfully sent (to trigger re-render if needed). */
  onSent?: () => void;
}
...
/**
 * GeneralMessageComposer — compose + send (+ optional attach) for the CLIENT general-thread view.
 *
 * AC-MSG-001-04: CLIENT can send messages in the general thread.
 * AC-MSG-004-01: optional file attachment on send.
 * AC-MSG-003-01/-02: body passes to server verbatim (no client-side transform).
