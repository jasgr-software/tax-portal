/**
 * apps/admin/src/app/messages/_components/AttachmentList.tsx
 *
 * Attachment list for a message in the ACCOUNTANT (admin) thread view.
 *
 ...
 *
 * CS-TS-003: mirrors AttachmentList in apps/portal (same structure). // CS-TS-003
...
/**
 * AttachmentList — renders download links for message attachments (ACCOUNTANT surface).
 *
...
/**
 * AttachmentItem — renders a single attachment row (ACCOUNTANT surface).
 *
 * SECURITY:
