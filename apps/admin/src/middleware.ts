/**
 * apps/admin/src/middleware.ts — Per-app Next.js middleware for Tax Portal (admin)
 *
 ...
 *
 * Mirrors apps/portal/src/middleware.ts (CLAUDE.md § Platform-frontend scope).
 *
 * Note: This file lives in src/ because the admin app uses the src/ directory structure.
