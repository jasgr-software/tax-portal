...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Plan**           | **Backlog triage (new epics only):** run § Backlog triage before any other Plan work. **Context pre-flight:** ask user to run `/compact`. Read epic requirements + architecture docs. Docker pre-flight. Create feature branch. Break epic into tasks. **Design coherence gate.** Update PROGRESS.md.                                                              |
