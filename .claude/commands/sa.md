...
Read `docs/tasks/PROGRESS.md` to determine the current phase. Read `CLAUDE.md` for project configuration. Read `.architecture/c4/README.md` and `.architecture/TENETS.md` for architectural context. Read `.architecture/decisions/` for prior decisions.
