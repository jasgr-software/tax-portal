...
Read `docs/tasks/PROGRESS.md` to determine the current phase. Read `CLAUDE.md` for project configuration. Read `docs/architecture/C4.md` for architectural context. Read `docs/decisions/` for prior decisions.
